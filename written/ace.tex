...
{\color{red}[JDC: The 2.6 log unit number was not an attempt to guess how much error neglect of protonation states could lead to.  It was just an attempt to determine what size pKa shift could be tolerated while still maintaining sub-nM potency.]}
...
{\color{red}[JDC: The last two sentences duplicate the previous paragraph.]}
...
{\color{red}[JDC: Not sure where this bit below is supposed to go.  Maybe in Subaim 2.2, or in the intro above the subaims?]}
...
%
We will extend our Bayesian analysis tools with the capacity to use binding polynomials (\Cref{equation:bindingpolynomial}) to estimate the binding affinity.
%
