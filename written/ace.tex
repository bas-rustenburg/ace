...
\begin{figure}
  ...
  \ffigbox[\textwidth]{
    \begin{subfloatrow}[3]%\useFCwidth
      ...
      \subfloatrowsep
      \fcapside[\FBwidth]{\includegraphics[width=.28\textwidth]{figures/guest11_side.png}}{\caption{}}%
      \subfloatrowsep
      \fcapside[\FBwidth]{\includegraphics[width=.28\textwidth]{figures/guests_2d.png}}{\caption{}}%
    \end{subfloatrow}}
