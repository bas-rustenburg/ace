...
Imatinib, a potent inhibitor of Abl kinase~\autocite{Druker2001a}, has access to multiple protonation states at physiological \pH (\Cref{figure:imatinib-pKa})~\autocite{Szakacs2005a}.
%
...
%
\begin{align}
 Q = 1 + K_1x + K_1K_2x^2 + \cdots + \left(\prod\limits_{i=1}^{n} K_i\right) x^n = 1 + \sum\limits_{l=1}^n \left(\prod\limits_{i=1}^{l} K_l\right)x^l \quad,
 \label{equation:bindingpolynomial}
\end{align}
which is equivalent to the partition function of the system~\autocite{Dill2010a}.
{\color{red}[JDC: What is $x$ and $Q$ here?]}
