...
\begin{figure}
  ...
  \ffigbox[\textwidth]{
    \begin{subfloatrow}[3]%\useFCwidth
      \fcapside[\FBwidth]{\includegraphics[width=.27\textwidth]{figures/guest1.png}}{\caption{}}%
      \subfloatrowsep
      \fcapside[\FBwidth]{\includegraphics[width=.27\textwidth]{figures/guest11.png}}{\caption{}}%
      \subfloatrowsep
      \fcapside[\FBwidth]{\includegraphics[width=.27\textwidth]{figures/guest19.png}}{\caption{}}%
    \end{subfloatrow}}
{\caption{\textbf{Cucurbit[7]uril bound to several cationic guests from \textcite{Cao2013a}}. Different guests with different sizes can bind to the cavity, though their affinity is determined by their total charge, geometry and size. (a) Guest 1 is small and divalent, ($K_a =$ \SI{2.0e4}{\per\Molar}), (b) Guest 11 is larger and divalent, ($K_a =$ \SI{1.7e7}{\per\Molar}), (c) Guest 19 is bulky and monovalent, ($K_a =$ \SI{2.1e10}{\per\Molar} ). Figure prepared using Glide docking\cite{Halgren2004a,Friesner2004a,Friesner2006a,Schroedinger2014a} into crystal structure pdb:QQ7\cite{Feng2004a}.}\label{figure:host-guest}}
...
\begin{figure}
	...
	\todo[inline,color=red!40]{figure with binding sites illustrated instead, show small molecules we will use}
\end{figure} 
% \subsubsection*{Methods}
