...
%
While these methods hold considerable promise in the accurate prediction of small molecule biding free energies {\color{red}[CITE T4 lysozyme, FKBP, and Schrodinger benchmark papers]}, their domain of applicability is currently highly restricted; and the broad application of free energy calculations to numerous pharmacologically relevant targets requires a number of additional challenges to be overcome~\autocite{Chodera2011a,Gapsys2015a}. 
%
...
{\color{red}[JDC: Talk about Abl:imatinib system here and the evidence for protonation state effects there.]}
...
{\color{red}[JDC: This one sentence on kinase inhibitors is insufficient to motivate your readers into believing you that this is important.  I'd lead with the Abl example up above where I have marked this in red, then go into the how the scope of the problem is unknown, as you already have written.]}
%
...
{\color{red}[JDC: Where is this figure referenced?]}
}
...
%
Then, we will perform constant-\pH free energy calculations, feeding in the input from complex \pKa value estimates.
%
