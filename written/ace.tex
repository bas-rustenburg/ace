...
\begin{figure}[H]
	...
	\todo[inline,color=green!40]{bold face first sentence. which guest, what affinity, show another one?}
...
\begin{SCfigure}
	\centering
	\includegraphics[width=0.5\textwidth]{figures/hsa_fig7_ghuman2005.jpg}
